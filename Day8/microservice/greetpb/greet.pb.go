...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x0a, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6f, 0x74, 0x22, 0x44, 0x0a, 0x15, 0x47,
	...
	0x67, 0x22, 0x30, 0x0a, 0x16, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69,
	...
	0x75, 0x6c, 0x74, 0x32, 0xd6, 0x01, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x43, 0x61, 0x6c, 0x63,
	0x53, 0x71, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x18, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x53,
	0x71, 0x75, 0x61, 0x72, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x19, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x52,
	0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x0e, 0x47,
	...
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07,
...
var file_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*SquareRootRequest)(nil),      // 3: greet.SquareRootRequest
	(*SquareRootResponse)(nil),     // 4: greet.SquareRootResponse
...
var file_greetpb_greet_proto_depIdxs = []int32{
	...
	3, // 3: greet.GreetService.CalcSqRoot:input_type -> greet.SquareRootRequest
	...
	4, // 6: greet.GreetService.CalcSqRoot:output_type -> greet.SquareRootResponse
...
type GreetServiceClient interface {
	...
	CalcSqRoot(ctx context.Context, in *SquareRootRequest, opts ...grpc.CallOption) (*SquareRootResponse, error)
...
func (c *greetServiceClient) CalcSqRoot(ctx context.Context, in *SquareRootRequest, opts ...grpc.CallOption) (*SquareRootResponse, error) {
	out := new(SquareRootResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/CalcSqRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	CalcSqRoot(context.Context, *SquareRootRequest) (*SquareRootResponse, error)
...
func (*UnimplementedGreetServiceServer) CalcSqRoot(context.Context, *SquareRootRequest) (*SquareRootResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CalcSqRoot not implemented")
}
...
func _GreetService_CalcSqRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SquareRootRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).CalcSqRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/CalcSqRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).CalcSqRoot(ctx, req.(*SquareRootRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CalcSqRoot",
			Handler:    _GreetService_CalcSqRoot_Handler,
		},
	},
